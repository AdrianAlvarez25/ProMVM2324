// En tota la hora de classe m'estava fallant l'accés al GitHub (no estava al meu ordinador habitual), per tant no he tingut temps de fer commit de tots els canvis que he fet en el procés de fer aquesta pràctica.
